...
export const CardFeaturedPlaylist = ({name, descr, image, tracks}) => {
  ...
  return (
    <>
        <div onClick={ () => handleSaveUrlTrack(tracks) } className="card-featured relative flex flex-col bg-[#181818] hover:bg-[#282828] transition-all duration-700 cursor-pointer p-4 rounded-md mb-3 group animate-fill-forwards animate-duration-1000">
