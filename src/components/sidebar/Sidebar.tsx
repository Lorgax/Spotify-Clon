...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside className="col-span-2 row-span-1 bg-[#121212bf] rounded-md text-[#ffffffaf] mt-2 ms-2 p-5">
          <ul>
              <li>
      ...
      <aside className="col-span-2 row-span-5 bg-[#121212bf] rounded-md text-[#ffffffaf] my-2 ms-2 p-5">
          <ul>
              <li>
